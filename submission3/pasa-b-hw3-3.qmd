...
pf.etable(reduced_form_90, omit_stats='all', se=False)

```

### 9. Repeating the above steps, but for 1991-2015
```{python}
#| echo: false
#| warning: false
#| message: false
...
etable = pf.etable(
    [ols_70_90, ols_91_15, iv_70_90, iv_91_15],
...
etable = etable.tab_header(
    title=["OLS 1970-1990", "OLS 1991 - 2015", "IV 1970-1990", "IV 1991-2015"]
...
```{python}
etable_2 = pf.etable(
    [first_stage_90, reduced_form_90],
    title=["1970–1990 Sample", "1991–2015 Sample"],
    subheaders=["First Stage", "Reduced Form"],  # or other context if needed
    digits=3,
    signif_stars=True,
    signif_levels=[0.01, 0.05, 0.1],
